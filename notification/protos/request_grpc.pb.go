...
const (
	Request_EnqueRequest_FullMethodName = "/pb.request/EnqueRequest"
)
...
type RequestClient interface {
	EnqueRequest(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*EmailResponse, error)
}
...
func (c *requestClient) EnqueRequest(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*EmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmailResponse)
	err := c.cc.Invoke(ctx, Request_EnqueRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RequestServer interface {
	EnqueRequest(context.Context, *EmailRequest) (*EmailResponse, error)
...
func (UnimplementedRequestServer) EnqueRequest(context.Context, *EmailRequest) (*EmailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnqueRequest not implemented")
}
...
func _Request_EnqueRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RequestServer).EnqueRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Request_EnqueRequest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RequestServer).EnqueRequest(ctx, req.(*EmailRequest))
	}
...
var Request_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "EnqueRequest",
			Handler:    _Request_EnqueRequest_Handler,
		},
	},
